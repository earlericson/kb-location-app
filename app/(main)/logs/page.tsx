...
import { DateFilterBar } from "@/features/components/global/date-filter-bar";
...
export default function ActivityLogsPage() {
    ...
    return (
        <main className="max-w-7xl md:mx-auto mx-5 py-5">
            <DateFilterBar startDate={startDate} endDate={endDate} onChange={(update) => setDateRange(update)} />
